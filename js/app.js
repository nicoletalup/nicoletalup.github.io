document.addEventListener('DOMContentLoaded', () => {
  ...
  const EMAILJS_TEMPLATE_ID = "YOUR_TEMPLATE_ID"; // e.g. "template_appointment"
    ...
    if (typeof emailjs !== 'undefined' && EMAILJS_PUBLIC_KEY !== "YOUR_PUBLIC_KEY" && EMAILJS_PUBLIC_KEY !== "") {
      ...
      emailjs.send(EMAILJS_SERVICE_ID, EMAILJS_TEMPLATE_ID, templateParams)
        ...
        .catch((error) => {
          ...
          alert("Ne cerem scuze! A apărut o eroare la trimiterea programării. Vă rugăm să încercați din nou sau să ne contactați telefonic la (+40) 757 796 362.");
      ...
      console.log("EmailJS is not configured yet. Simulating mail transmission...");
      setTimeout(() => {
        showSuccess();
      }, 1200);
    }
